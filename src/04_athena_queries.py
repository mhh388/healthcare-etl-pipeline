...
def create_athena_table(athena_client, database: str, year: str):
    ...
    CREATE EXTERNAL TABLE IF NOT EXISTS {database}.partd_prescribers (
        ...
        generic_name            STRING,
        total_claims            DOUBLE,
        total_30day_supply      DOUBLE,
        total_day_supply        DOUBLE,
        total_drug_cost         DOUBLE,
        total_beneficiaries     DOUBLE,
        senior_suppression_flag STRING,
        senior_total_claims     DOUBLE,
        senior_30day_supply     DOUBLE,
        senior_drug_cost        DOUBLE,
        senior_beneficiaries    DOUBLE,
        cost_per_claim          DOUBLE,
        cost_per_beneficiary    DOUBLE,
        senior_claim_rate       DOUBLE,
        drug_type               STRING,
        data_year               INT,
        processed_at            STRING,
